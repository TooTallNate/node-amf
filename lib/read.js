...
function read (buffer, offset, d) {
  ...
  switch (type) {
    ...
    case amf0Types.kStrictArrayType:
      return readStrictArray(buffer, i, d);
    case amf0Types.kDateType:
      return readDate(buffer, i, d);
    default:
...
function readECMAArray (buffer, offset, b, a) {
  var off = offset | 0;
  var key, value;
  ...
  readObject(buffer, off, b, a);
  return a;
}

function readStrictArray (buffer, offset, b, a) {
  var off = offset | 0;
  var key, value, d;
  if (!Array.isArray(a)) a = [];
